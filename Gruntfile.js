    ...
    buildcontrol: {
      dist: {
        options: {
          ...
          remote: 'git@github.com:smongey/aok2.git',
          branch: 'gh-pages'
        }
      }
    },
      ...
      dist: {
        options: {
          patterns: [
            {
              match: /("|'?)\/?styles\//g,
              replacement: '$1http://smongey.github.io/aok2/styles/'
            },
            {
              match: /("|'?)\/?scripts\//g,
              replacement: '$1http://smongey.github.io/aok2/scripts/'
            },
            {
              match: /(<a[^>]*href="?)(\/)/g,
              replacement: '$1http://smongey.github.io/aok2/'
            },
            {
              match: /(<form[^>]*action="?)(\/)/g,
              replacement: '$1http://smongey.github.io/aok2/'
